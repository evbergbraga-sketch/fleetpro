...
function renderInvestidores(){
  ...
  <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-bottom:20px">
    ...
    <div class="stat-card" style="--accent-color:#2563EB"><div class="stat-icon">📊</div><div class="stat-label">Taxa de ocupação</div><div class="stat-val" style="color:#2563EB">${ocupFinal}%</div><div class="stat-sub">${veiculosFinal.filter(v=>v.status==='alugado').length} de ${totalVeic} alugados</div></div>
    <div class="stat-card" style="--accent-color:#dc2626"><div class="stat-icon">🔧</div><div class="stat-label">Custo manutenções</div><div class="stat-val" style="color:#dc2626;font-size:22px">R$ ${custoManut.toLocaleString('pt-BR',{minimumFractionDigits:2})}</div><div class="stat-sub">${manutFinal.length} registros</div></div>
  </div>
